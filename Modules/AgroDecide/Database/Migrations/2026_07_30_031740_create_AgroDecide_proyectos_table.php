...
return new class extends Migration {
    public function up() {
        Schema::create('AgroDecide.proyectos', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('lote_id')->references('id')->on('AgroDecide.lotes')
                ->onDelete('restrict');
    ...
    public function down() {
        Schema::dropIfExists('AgroDecide.proyectos');
    }
};
