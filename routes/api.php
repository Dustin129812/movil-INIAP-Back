...
Route::prefix('auth')->group(function () {
    ...
    Route::post('login-invitado', [AuthController::class, 'loginInvitado'])->name('login-invitado');
});
...
require_once base_path('Modules/Transferencia/Routes/api.php');
require_once base_path('Modules/TrlImporter/Routes/api.php');

Route::middleware('auth:api')->prefix('lotes')->group(function () {
...
Route::middleware('auth:api')->prefix('ubicacion')->group(function () {
